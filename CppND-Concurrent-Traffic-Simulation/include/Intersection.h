...
#ifndef CPPND_CONCURRENT_TRAFFIC_SIMULATION_INCLUDE_INTERSECTION_H_
#define CPPND_CONCURRENT_TRAFFIC_SIMULATION_INCLUDE_INTERSECTION_H_
...
#endif   //  CPPND_CONCURRENT_TRAFFIC_SIMULATION_INCLUDE_INTERSECTION_H_
