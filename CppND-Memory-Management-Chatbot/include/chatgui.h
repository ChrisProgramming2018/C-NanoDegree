...
#ifndef CPPND_MEMORY_MANAGEMENT_CHATBOT_INCLUDE_CHATGUI_H_
#define CPPND_MEMORY_MANAGEMENT_CHATBOT_INCLUDE_CHATGUI_H_
...
#endif  // CPPND_MEMORY_MANAGEMENT_CHATBOT_INCLUDE_CHATGUI_H_"
